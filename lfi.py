...
import urllib2
##url = 'http://localhost.com.ar/index.php?main='
...
def banner():
	print(colored("#############################################################", 'green'))
        print(colored("                                                             ", 'red'))
	print(colored('LFI vulnerable Website Finder                                ', 'blue'))
        print(colored('Version: 1.0                                                 ', 'yellow'))
	print(colored('Developer: Ritik Dubey and Pradeep Singh                     ', 'red'))
	print(colored('email: ritikdubey111@gmail.com and pradeepsinghnitk@gmail.com', 'white'))
        print(colored("                                                             ", 'red'))
        print(colored('#############################################################', 'red'))         
def dorks():
	urls = []
